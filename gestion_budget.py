...
def la_depense(montant, la_depense):
    ...
    table = db.table('loyer')
    table.insert({'value': True})
    table = db.table('transport')
    table.insert({'value': True})
    table = db.table('tontine')
    table.insert({'value': True})
    table = db.table('factures')
    table.insert({'value': True})
    table = db.table('scolarité')
    table.insert({'value': True})
...
def le_revenu(montant, le_revenu):
    ...
    table = db.table('paiement')
    table.insert({'value': True})
    table = db.table('business')
    table.insert({'value': True})
    table = db.table('tontine')
    table.insert({'value': True})
    table = db.table('salaire')
    table.insert({'value': True})
    table = db.table('marché')
    table.insert({'value': True})
